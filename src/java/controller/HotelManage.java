 ...
 * @author Văn Phú
 */
public class HotelManage extends HttpServlet {
    ...
    if (user != null) {
        ...
        List<Hotel> listHotel = hDB.getHotelByOwnerID(o.getOwnerID());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        HotelDAO hDB = new HotelDAO();
        String hotelId = request.getParameter("hotelId");
        hDB.deleteHotelByID(hotelId);
        response.sendRedirect("hotelmanage");
