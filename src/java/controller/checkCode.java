...
protected void doPost(HttpServletRequest request, HttpServletResponse response)
   ...
   String hotelID= (String)session.getAttribute("hotelID");
    // Kiểm tra xem booking_code có tồn tại không
    BookingDAO bookingDAO = new BookingDAO();
    Booking booked = bookingDAO.checkBookingExist(booking_code,hotelID);
    
    if (booked != null) {
        session.setAttribute("BookingID", booking_code);
        request.setAttribute("checkExistBooking", true);
    } else {
        request.setAttribute("checkExistBooking", false);
    }
