...
<section class="ftco-section ftco-book ftco-no-pt ftco-no-pb">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <form action="hotelmanage" class="appointment-form">
                    <div class="col-md-12"> 
                        <%  RoomTypeDAO rDB= new RoomTypeDAO();
                        ...
                        <div class="col" style="display: flex; justify-content: space-between;">
                            <p class="card-text" style="display: inline-block;"><strong>Loại phòng:</strong> <%= rDB.getRoomTypeByID(b.getRoomTypeID()).getRoomTypeName()%></p>
                        ...
                        <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
                            <div class="d-block services-wrap text-center">
                                ...
                                <div class="media-body py-4 px-3">
                                    <h3 class="heading"><%=  rDB.getRoomTypeByID( b.getRoomTypeID()).getRoomTypeName() %></h3>
