...
public class checkIn extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Booking> bookList = bDB.getListBookingDetailByID(bookingID);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
//        HttpSession session = request.getSession();
//        Booking b= (Booking)session.getAttribute("BookingInfo");
//        BookingDAO bookDB= new BookingDAO();
//        List<Booking> bookList= bookDB.getBookingByID(b.getBookingID());
//        request.setAttribute("bookingList", bookList);
//        request.getRequestDispatcher("checkIn.jsp").forward(request, response);
//        String booking_code = request.getParameter("B001");
